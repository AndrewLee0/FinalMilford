...
<body>
<div  role="dialog" id="succWindow">
  <div class="modal-dialog">
    <div class="modal-content" id ="modalDatei">
      <div class="modal-header">
        <h4 class="modal-title">Message Sent</h4>
      </div>
      <div class="modal-body">
        <p>Your message was successfully sent to Milford Accounting's staff: We will respond to you as soon
        as possible.</p>
      </div>
        ...
        <div class="container">
            <div class="row entryBoxes">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate method="post" action="experimentalContactResponse.php">
